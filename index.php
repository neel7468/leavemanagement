...
<head>
	<!-- Basic Page Info -->
	<meta charset="utf-8">
	<title>NLM Leave Manager</title>

	<!-- Site favicon -->
	<link rel="apple-touch-icon" sizes="100x100" href="vendors/images/nlmicon.png">
	<link rel="icon" type="image/png" sizes="32x32" href="vendors/images/nlmicon.png">
	<link rel="icon" type="image/png" sizes="16x16" href="vendors/images/nlmicon.png">
	...
	<div class="login-header box-shadow">
		<div class="container-fluid d-flex justify-content-between align-items-center">
			<div class="brand-logo">
				<a href="login.html">
					<img src="vendors/images/nlmicon.png" alt="">
				</a>
			</div>
		</div>
	</div>
